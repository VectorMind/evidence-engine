...
| [2026-06-28-entity-layer-ownership](2026-06/28-entity-layer-ownership/) | 2026-06-28 | Supersedes the ambiguous Layer-4 boundary: `even` now owns generic entity catalog tables while private Knowledge and custom semantics stay above the engine. | Implemented with README/spec/schema updates, catalog `0.10` / `user_version=10`, focused schema tests, repo suite, and Ruff proof. See [implementation.md](2026-06/28-entity-layer-ownership/implementation.md) and [test.md](2026-06/28-entity-layer-ownership/test.md). |
...
| [2026-06-27-routing-decomposition](2026-06/27-routing-decomposition/) | 2026-06-27 | `routing.py` decomposed into a 12-module `routing/` package behind an import-preserving facade. Takeover verification also hardened optional media backend imports so repo-wide proof is not blocked by unrelated Pillow/PyMediaInfo DLL load failures. | Current takeover proof: routing tests `21 passed, 8 skipped`; repo suite `56 passed, 13 skipped`; Ruff clean. See [implementation.md](2026-06/27-routing-decomposition/implementation.md) and [test.md](2026-06/27-routing-decomposition/test.md). |
| [2026-07-04-entity-layer-runtime](2026-07/04-entity-layer-runtime/) | 2026-07-04 | First real Layer-4 producer: `even entity add/list/show/alias/link/review/find` runtime and CLI, a search-assisted discovery bridge with `--propose`, generic `resolve_ref` reference hydration, and a synthetic worked example ("Northwind Salvage") proving discovery→bind→review end-to-end and the durable-review guarantee across re-parse/re-index. | `uv run pytest` 90 passed (19 new); worked example and durability diffs verified live. See [implementation.md](2026-07/04-entity-layer-runtime/implementation.md) and [test.md](2026-07/04-entity-layer-runtime/test.md). |
| [2026-07-04-plans-layout-refactor](2026-07/04-plans-layout-refactor/) | 2026-07-04 | Refactored plan packets into `plans/YYYY-MM/DD-<slug>/`, updated the workflow contract, and fixed internal references to the moved packets. | Tree migration plus repo-wide stale-path scans recorded in [implementation.md](2026-07/04-plans-layout-refactor/implementation.md) and [test.md](2026-07/04-plans-layout-refactor/test.md). |
