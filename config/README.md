...
- `min_representative_score_gap`: minimum score gap between the top two
  ...
  current FTS scopes.
- `summary_sample_chunks_default`: maximum document chunks or media assets
  sampled into one summary prompt.
- `summary_sample_chars_per_chunk`: excerpt budget per sampled chunk or media
  caption.
