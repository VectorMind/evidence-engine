...
from documents_manager.paths import reports_root, results_root, workspace_root
...
<main>
  ...
  <p class="muted">Generated by documents-manager from a structured command result.</p>
  <h2>Overview</h2>
  {overview}
...
<main>
  <h1>{html.escape(title)}</h1>
  <p class="muted">Generated by documents-manager from a structured parse result.</p>
  <h2>Overview</h2>
  {overview}
